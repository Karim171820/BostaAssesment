...
<div className="input-group mb-3" style={{maxWidth:"300px", margin: "auto", height: "100px", padding: "80px 0"}}>
  <input type="text" className="form-control"  value={number} onChange={(e: any) => setNumber(e.target.value)} placeholder="Recipient's username" aria-label="Recipient's username" aria-describedby="basic-addon2"/>
